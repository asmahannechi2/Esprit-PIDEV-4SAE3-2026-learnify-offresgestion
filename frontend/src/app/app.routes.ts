...
export const routes: Routes = [
  ...
  // Badges & Certificate Requests (CODE4)
  { path: 'badges', component: BadgesComponent, canActivate: [studentPreevaluationGateGuard] },
  { path: 'my-requests', component: MyRequestsComponent, canActivate: [studentPreevaluationGateGuard] },
  ...
  { path: 'video-pitch/:id', component: VideoPitchComponent, canActivate: [studentPreevaluationGateGuard, authGuard] },
  { path: 'meet-room/:roomName', loadComponent: () => import('./pages/meet-room/meet-room.component').then(m => m.MeetRoomComponent), canActivate: [studentPreevaluationGateGuard, authGuard] },
