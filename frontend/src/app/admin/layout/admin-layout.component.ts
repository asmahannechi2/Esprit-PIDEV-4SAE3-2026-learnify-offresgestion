...
export class AdminLayoutComponent {
    ...
    navItems: { path: string; icon: string; label: string; linkExact?: boolean }[] = [
        ...
        { path: '/admin/candidates/create', icon: 'ti ti-user-search', label: 'Add Candidate' },
        ...
        { path: '/admin/applications', icon: 'ti ti-clipboard-list', label: 'Applications' },
        { path: '/admin/meetings', icon: 'ti ti-calendar-check', label: 'Meetings' },
        { path: '/admin/ratings', icon: 'ti ti-star', label: 'Ratings' },
        { path: '/admin/mongo-posts', icon: 'ti ti-database', label: 'Posts Mongo' },
