...
import { AddCandidateComponent } from './candidates/add-candidate.component';
...
import { AdminMongoPostsListComponent } from './mongo-posts/mongo-posts-list/admin-mongo-posts-list.component';
import { AdminMongoPostFormComponent } from './mongo-posts/mongo-post-form/admin-mongo-post-form.component';
...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'candidates/create', component: AddCandidateComponent },
            ...
            // Applications (toutes les offres, puis filtre par job)
            ...
            // Posts MongoDB (mongo-event-service)
            { path: 'mongo-posts', component: AdminMongoPostsListComponent },
            { path: 'mongo-posts/create', component: AdminMongoPostFormComponent },
            { path: 'mongo-posts/edit/:id', component: AdminMongoPostFormComponent },
        ],
    },
];
