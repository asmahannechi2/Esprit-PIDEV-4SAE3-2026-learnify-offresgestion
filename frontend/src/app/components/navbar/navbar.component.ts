...
export class NavbarComponent implements OnInit, OnDestroy {
  ...
  onNotificationClick(notif: JobNotification): void {
    this.markOneRead(notif);
    // If it's a meeting and has a room, we could auto-navigate, 
    // but the user might just want to read. The button is better.
  }
